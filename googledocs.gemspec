...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'shoulda-matcher',   '1.0.0.beta2'
  s.add_development_dependency 'shoulda-context',   '1.0.0.beta1', :git => 'git@github.com:james2m/shoulda-context.git'
end